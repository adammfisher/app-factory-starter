...
## Not decided yet
- Which tip percent is selected the first time the app ever opens.
- Whether a saved bill can carry an optional note, such as the restaurant name.
